...
jQuery( document ).ready(
	function() {
		...
		n7_golf_club_add_filter('trx_addons_filter_sc_classes', function(classes, settings) {
		...
		setTimeout( function() {
			if ( window.elementor !== undefined ) {
				...
				jQuery( '#elementor-panel' )
					.on( 'input change', '[data-setting^="n7_golf_club_options_"]', function (e) {
						...
						var link = jQuery( this ).parents( '.elementor-control' ).find( 'a.n7_golf_club_post_editor' );
						if ( link.length > 0 ) {
							n7_golf_club_change_post_edit_link_elementor( link );
						}
					} )
					.on( 'click', '.n7_golf_club_post_editor', function(e) {
						n7_golf_club_change_post_edit_link_elementor( jQuery(this) );
						if (jQuery(this).hasClass('n7_golf_club_hidden' )) {
							e.preventDefault();
							return false;
						}
					});
		...
		function n7_golf_club_change_post_edit_link_elementor(a) {
			if (a.length > 0) {
