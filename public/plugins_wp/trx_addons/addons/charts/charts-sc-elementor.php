...
if (!function_exists('trx_addons_sc_charts_black_list')) {
	add_action( 'elementor/widgets/black_list', 'trx_addons_sc_charts_black_list' );
	function trx_addons_sc_charts_black_list($list) {
		$list[] = 'TRX_Addons_SOW_Widget_Charts';
		return $list;
	}
}
