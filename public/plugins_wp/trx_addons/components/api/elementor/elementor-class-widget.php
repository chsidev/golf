...
//					),
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .sc_item_title_text' => '-webkit-text-fill-color:transparent;-webkit-background-clip:text;background-clip:text;background-image:url({{URL}});background-position:left center;'
					)
				),
				array(
...
//					),
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .sc_item_title_text2' => '-webkit-text-fill-color:transparent;-webkit-background-clip:text;background-clip:text;background-image:url({{URL}});background-position:left center;'
					)
				),
				array(
...
*/
		...
		// Display a placeholder for a shortcode
