...
function trx_addons_gutenberg_add_param_filters(props) {
	...
	var post_type = props.attributes.post_type,
		taxonomy  = props.attributes.filters_taxonomy;
	...
	var params = trx_addons_apply_filters(
					...
					[
						...
						// Filters taxonomy
						{
							...
							'type': 'select',
							'options': trx_addons_gutenberg_get_lists( TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type], true ),
							'dependency': {
								'show_filters': [true]
							}
						},
						...
						{
							'name': 'filters_ids',
							'title': __( 'Filters taxonomy to show', "trx_addons" ),
