...
if ( !function_exists( 'trx_addons_vc_load_responsive_styles' ) ) {
	...
	function trx_addons_vc_load_responsive_styles() {
		if ( trx_addons_exists_vc() && trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-js_composer-responsive', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_API . 'js_composer/js_composer.responsive.css'), array(), null, trx_addons_media_for_load_css_responsive( 'vc', 'lg' ) );
		}
	}
}
...
// Disable load animations to the Frontend Editor
