...
if (!function_exists('trx_addons_sc_layouts_featured_black_list')) {
	add_action( 'elementor/widgets/black_list', 'trx_addons_sc_layouts_featured_black_list' );
	function trx_addons_sc_layouts_featured_black_list($list) {
