...
if ( ! function_exists( 'n7_golf_club_trx_addons_get_css' ) ) {
	add_filter( 'n7_golf_club_filter_get_css', 'n7_golf_club_trx_addons_get_css', 10, 2 );
	function n7_golf_club_trx_addons_get_css( $css, $args ) {
