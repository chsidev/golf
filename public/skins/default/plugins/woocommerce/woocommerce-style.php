...
if ( ! function_exists( 'n7_golf_club_woocommerce_get_css' ) ) {
	add_filter( 'n7_golf_club_filter_get_css', 'n7_golf_club_woocommerce_get_css', 10, 2 );
	function n7_golf_club_woocommerce_get_css( $css, $args ) {
...
$fdir = n7_golf_club_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
    require_once $fdir;
}
