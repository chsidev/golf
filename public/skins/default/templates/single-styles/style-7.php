...
if ( apply_filters( 'n7_golf_club_filter_single_post_header', is_singular( 'post' ) || is_singular( 'attachment' ) ) ) {
	...
	ob_end_clean();
	$n7_golf_club_with_featured_image = n7_golf_club_is_with_featured_image( $n7_golf_club_post_header, array( 'with_gallery' ) );
	// Post title and meta
	ob_start();
	...
	if ( strpos( $n7_golf_club_post_header, 'post_featured' ) !== false
		...
		<div class="post_header_wrap post_header_wrap_in_header post_header_wrap_style_<?php
            ...
            if ( $n7_golf_club_with_featured_image ) {
                echo ' with_featured_image' . ( false && n7_golf_club_get_theme_option( 'single_parallax' ) == 0 ? ' n7-golf-club-full-height' : '' );
            }
		?>">
			<?php
